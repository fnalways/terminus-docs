...
Simply put, Terminus collaborates with protocols to bring better experience to users in more use cases beyond just privacy protection. There are two typical use cases:
