...
- Olares 设备已激活并正常运行。
- Olares ID 已[备份助记词](../get-started/back-up-mnemonics.md)。
- 手机上已安装 LarePass 应用。
...
::: tip 
你可以用标签高效地分类和关联相关内容，或者通过笔记直接在内容旁记录见解和想法。详细用法请参考[组织你的阅读](../tasks/wise-basics.md#组织你的阅读)。
:::
...
::: tip 智能内容推荐
除了常规的 RSS 订阅，Wise 还提供了完全本地运行、保护隐私的智能内容推荐系统，为你提供个性化内容推送。详情请参考[本地推荐算法](../tasks/recommend.md)。
:::
