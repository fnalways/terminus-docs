...
Wise 是你的数字后花园。它是一款本地优先且 AI 原生的现代化阅读器，它能帮助你收集，阅读和管理来自各个平台的信息。你可以在 Wise 中运行自托管的推荐算法，帮助你筛选和排序各类互联网上的内容，打破信息茧房。结合 TermiPass 浏览器插件，你可以一键将有价值的文章保存到 Terminus 上，从而快速构建个人知识库
